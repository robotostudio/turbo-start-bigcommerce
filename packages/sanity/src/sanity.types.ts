...
// Query: *[_type == "bigcommerceCategory" && defined(store.slug.current) && store.isDeleted != true]{    _id,    _createdAt,    "title": store.title,    "slug": store.slug.current,    "imageUrl": store.imageUrl,    "description": store.descriptionHtml  }
