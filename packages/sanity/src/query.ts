...
const editorialTwoUpBlock = /* groq */ `
  _type == "editorialTwoUp" => {
    ...
    "items": array::compact(items[]{
      ...
      // /collections/[...slug] is prerendered from queryCollectionPaths, which
      // spells it store.isVisible == true, so a card linking a category that
      // query drops is a link to a 404.
      //
  ...
  *[_type == "navbar" && _id == "navbar"][0]{
    ...
    columns[]{
      ...
      _type == "collectionGroup" => {
        ...
        // dropdown is one more surface that can link a category
        // queryCollectionPaths never prerenders.
        //
